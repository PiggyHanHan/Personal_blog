...
const ASSETS = {
  door: THEME_ASSETS.doorScene,
  chibi: "/hutao/使用中/小素材/chibi1.png",
  chibi2: THEME_ASSETS.chibiBurst,
  vision: THEME_ASSETS.vision,
  fire: THEME_ASSETS.fire,
...
// 单个神之眼单元见 components/ui/FireVision.tsx（开屏与私有文章门扉共用）
